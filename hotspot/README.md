...
> **定位**：雷达站。追踪大模型推理相关的行业动态、关键技术论坛、社区讨论与视频资源，沉淀为可回溯的热点档案。
...
| `current-session-prompt-review.md` | [当前任务提示词](2026-09/current-session-prompt-review.md) | 当前任务的提示词整理版，包含资料采集标准、热点档案格式、月度归档规则、README 刷新规则与远端同步要求。 |
